...
char dato[]={'0','|','0','|','0','|','0','|','0','|','0','|','0','\0'};  //Vector que guarda el estado de las bombas y los sensores
int bom1;
...
void main() {
    ...
    while(1)
    {
        ...
        //UART1_Write_Text(bom1); //Envio el estado de las bombas y los sensores
